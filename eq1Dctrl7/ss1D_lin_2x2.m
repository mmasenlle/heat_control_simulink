function [sys,x0,str,ts,simStateCompliance] = ss1D_lin_2x2_3(t,x,u,flag)
%
% Modelo para obtencion de linealizaciones potencia y velocidad
%

global iters ttimes params nodes data;
...
switch flag,
    ...
    case 0, % Initialization %
        ...
        sizes.NumOutputs     = 2; % T(op),T(op2)
        sizes.NumInputs      = 2; % [power,1/v]
    ...
    case 1, 
        ...
        sys = derTemp1_run(params,data,x,t);
