...
params.input_z = 0;
% puntos donde se mide temperatura
params.output_x = params.input_x - (.006);
params.output_y = params.input_y + 0;
params.output_z = params.input_z;
params.output_x2 = params.input_x + 0;
